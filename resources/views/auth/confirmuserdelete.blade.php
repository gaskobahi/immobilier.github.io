        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <h2 align="center">Etes vous sûr de vouloir supprimer <strong data-bgColor="red">{{$user->pseudo}}</strong>?</h2><br/>
                    <!-- start pop-over -->
                    <div  align="center" class="bs-example-popovers">
                        <form class="form-horizontal" role="form" method="POST" action="{{ route('user.confirmdelete',$user->id) }}" novalidate>
                            {{ csrf_field() }}
